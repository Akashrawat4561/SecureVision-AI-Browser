            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                <div className="space-y-3">
                    ...
                    <p className="text-slate-500 text-sm font-medium max-w-xl">
                        Paste any suspicious email subject and body to detect phishing attempts using AI analysis.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="glass-panel p-10 relative overflow-hidden group">
                    ...
                    <div className="flex items-center space-x-4 mb-10">
                        ...
                        <h2 className="text-2xl font-black text-white uppercase italic tracking-tighter font-heading">Email Input</h2>
                    </div>

                    <form onSubmit={handleAnalyze} className="space-y-8 relative z-10">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Email Subject</label>
                            <input
                                type="text"
                                value={subject}
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Email Body</label>
                            <textarea
                                value={body}
                        ...
                        {result ? (
                            ...
                            >
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="flex flex-col items-center justify-center p-8 bg-slate-950/80 rounded-[40px] border border-white/5 relative overflow-hidden group/gauge shadow-inner">
                                        ...
                                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] font-mono">AI Confidence Score</span>
                                    </div>
                                ...
                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex-1 bg-slate-950/80 border border-white/5 rounded-[40px] p-8 space-y-8 overflow-y-auto custom-scrollbar shadow-inner">
                                    ...
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest ml-1">Subject Analysis</p>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center opacity-20 group-hover:opacity-30 transition-opacity">
                                ...
                                <p className="text-[11px] text-slate-500 font-bold uppercase tracking-widest text-center max-w-xs leading-relaxed">
                                    Submit an email above to see the analysis results.
                                </p>
                            </div>
                        )}
                    </AnimatePresence>
