...
const navItems = [
    ...
    { group: 'Analysis', items: [
        { label: 'Anomaly', path: '/anomaly', icon: Activity },
        { label: 'Honeypot', path: '/honeypot', icon: Bug },
        { label: 'Predictive', path: '/predictive', icon: Share2 },
    ]},
    { group: 'Infrastructure', items: [
        { label: 'Edge Nodes', path: '/edge', icon: Cpu, badge: 'LIVE' },
                ...
                <div className="glass-card p-5 relative overflow-hidden group border-brand-cyan/20">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-2.5">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-slate-300">NEURAL_NET: ACTIVE</span>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between text-[11px]">
                            <div className="flex flex-col">
                                <span className="text-slate-500 font-bold uppercase tracking-tight text-[8px] mb-0.5">Core Sync</span>
